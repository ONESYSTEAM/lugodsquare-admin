            ...
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-light text-left p-5">
                        ...
                        <h6 class="font-weight-light">Scan your ID to logout.</h6>
                        <form action="/logoutWithID/login" method="post" class="pt-3">
                            <div class="form-group mb-2">
                                <input type="text" class="form-control form-control-lg" name="idNumber" placeholder="ID Number">
                            </div>
